...
<div class="space-y-32">
	<Section
		title="Data provider"
		description="Contact details for the person uploading this dataset"
	>
		<PersonalInformation />
		<Institution />
	</Section>

	<Section title="Dataset" description="Imformation identifying the dataset">
		<DatasetMetadata />
	</Section>
